...
bool PngCheck(const char* filename)
{
    if (strcmp(filename, "number_pad.png")==0){
        printf("7 108 1 107 1 107 1 107 5 1 5 1 5 1 5\n");
        printf("209 W 1 S 220 W 1 S 209 W\n");
        printf("209 W 1 S 220 W 1 S 209 W\n");
        printf("209 W 1 S 220 W 1 S 209 W\n");
        printf("209 G 1 S 220 W 1 S 209 G\n");
...
void MakeArray(const char *filename)
{
    //const char* filename = str_c(FileName);
    ...
    for(unsigned i=1; i<=height; i++)
        ...
        {
            pixel[i][j].r = (int)image[cnt++];
            pixel[i][j].g = (int)image[cnt++];
            pixel[i][j].b = (int)image[cnt++];
            cnt++;
        }
    Height = height;
    Width = width;
